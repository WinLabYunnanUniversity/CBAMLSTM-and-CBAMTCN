...
for snr in snrs:
    ...
    plot_confusion_matrix(confnorm, labels=mods, title="CBAMTCN Confusion Matrix (SNR=%d)" % (snr))
    filepath = 'C:/Users/admin/Desktop/TCN-with-attention-master/data/picture1/CBAMTCN/' + "ConvNet Confusion Matrix (SNR=%d)" % (snr) + 'SNR.png'
...
df1.to_csv('C:/Users/admin/Desktop/TCN-with-attention-master/data/datatcn1/CBAMTCN.csv', index=False)

plt.plot(snrs, list(map(lambda x: acc[x], snrs)))
plt.xlabel("Signal to Noise Ratio")
plt.ylabel("Classification Accuracy")
plt.title("CBAM+TCN Classification Accuracy on RadioML 2016.10 Alpha")
