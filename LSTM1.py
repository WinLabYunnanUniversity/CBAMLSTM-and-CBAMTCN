...
x = LSTM(128, return_sequences=True, recurrent_dropout=0.4)(x2)
x = LSTM(128,  dropout=0.4)(x)
...
model = Model(inputs=ConvInput, outputs=x_out, name='LSTM')
model.summary()
...
for snr in snrs:
    ...
    plot_confusion_matrix(confnorm, labels=mods, title="LSTM Confusion Matrix (SNR=%d)" % (snr))
    filepath = 'C:/Users/admin/Desktop/TCN-with-attention-master/data/picture1/LSTM1/' + "ConvNet Confusion Matrix (SNR=%d)" % (snr) + 'SNR.png'
...
df1.to_csv('C:/Users/admin/Desktop/TCN-with-attention-master/data/datatcn1/LSTM1.csv', index=False)
